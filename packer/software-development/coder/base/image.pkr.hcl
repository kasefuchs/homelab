...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo -E apt-get -y install apt-transport-https build-essential ca-certificates supervisor",

      # Install common utilities.
      "sudo -E apt-get -y install curl git gnupg htop jq lsb-release rclone rsync tree unzip wget",

      # Install editors.
      "sudo -E apt-get -y install micro nano vim",

      # Install shells.
      "sudo -E apt-get -y install bash fish zsh",
    ]
