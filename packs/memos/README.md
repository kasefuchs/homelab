...
<p align="center"> Nomad Pack used to automatically deploy Memos within a Nomad cluster.
    <br> 
</p>
...
This Pack contains everything needed to deploy Memos on a Nomad cluster. It uses the Docker driver.
...
environment = {
  ...
  MEMOS_DSN    = "postgresql://memos:memos@postgres.service.consul:5432/memos?sslmode=disable"
}
```
